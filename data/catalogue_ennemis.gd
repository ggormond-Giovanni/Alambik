...
static var TOUS := {
	"encrier_rampant": {
		...
		"forme": "goutte", "experience": 1, "chance_point": 0.07, "recharge": 1.7, "portee_tir": 680.0,
	...
	"plume_sentinelle": {
		...
		"forme": "plume", "experience": 2, "chance_point": 0.10, "recharge": 0.95, "vitesse_projectile": 620.0, "telegraphe": 0.40,
	...
	"scribe_essaimeur": {
		...
		"forme": "masque", "experience": 3, "chance_point": 0.16, "recharge": 2.6, "invoque": "encrier_rampant", "nb_invoques": 2, "max_invocations": 6,
