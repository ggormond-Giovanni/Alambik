...
static var TOUS := {
	...
	"pas_de_chat": Reactif.creer("pas_de_chat", "Pas de chat",
		...
		false, Color(0.72, 0.94, 0.78), "patte"),
	"fiole_de_vie": Reactif.creer("fiole_de_vie", "Fiole de vie",
		...
		false, Color(0.98, 0.42, 0.52), "fiole"),
